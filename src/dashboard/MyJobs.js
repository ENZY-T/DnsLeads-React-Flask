    ...
    return (
        <div className="job-card">
            <div className="inner p-4">
                <h3>
                    <Link className="txt-theme" to={`/my-jobs/${job.id}`}>
                        {job.topic}
                    </Link>
                </h3>
                <h5>
                    <LocationOnIcon />{' '}
                    <a href={job.location.link} target="_blank">
                        {job.location.name}
                    </a>
                </h5>
                <h5>
                ...
                <h5>
                    <ScheduleIcon /> Duration : {job.duration}
                </h5>
                <h5 className="mx-4">Start time : {job.startTime}</h5>
                {job.started ? (
